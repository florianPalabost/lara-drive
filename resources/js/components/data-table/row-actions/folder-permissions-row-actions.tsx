...
export interface FolderPermissionsListActions extends DataTableActions<DriveFile> {
    onRestoreFile?: (file: DriveFile) => void;
}

interface FolderPermissionsRowActionsProps {
    file: DriveFile;
}

export function FolderPermissionsRowActions({ file }: FolderPermissionsRowActionsProps) {
